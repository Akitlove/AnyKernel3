...
echo "1286400 1824000 46 45" > /sys/kernel/msm_thermal/zone5
echo "1132800 1670400 48 47" > /sys/kernel/msm_thermal/zone6
echo "1056000 1363200 50 49" > /sys/kernel/msm_thermal/zone7
echo "1056000 1056000 51 50" > /sys/kernel/msm_thermal/zone8
echo "1056000 902400 52 51" > /sys/kernel/msm_thermal/zone9
echo "1056000 748800 53 52" > /sys/kernel/msm_thermal/zone10
